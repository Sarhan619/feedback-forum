...
export default function Comment(props: Props) {
	...
	const {
		...
		error: deleteError,
		isLoading: deleting,
	} = useMutation('deleteComment', deleteComment, {
		// onMutate({ commentId }) {
		// 	let prevComments;
		...
		onSettled() {
			// queryClient.invalidateQueries(fetchFeedbackCommentsKey); // disrupts ux when deleting multiple comments (when optimistic updates is being used)
	...
	return (
		<Container deleting={deleting} {...restProps}>
